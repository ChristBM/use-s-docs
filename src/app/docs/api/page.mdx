...
| Built-in persistence             | ❌ Not yet  | Planned for version 2.3.0                                           |

---

Would you like to learn more?

Explore [Hook Config](/docs/api/hook-config) to see how you can have complete control over what `useS` does under the hood.
