...
> ℹ️ **Note:** If you want to maintain the best performance in your application,
> always pass the same reference or initialValue to useS().
> This is achieved by declaring initialValue outside the component and passing it to the hook.
